                ...
                return <li key={id} className="app_post">                   
                    <div className="post_title">
                        ...
                        <div className="post_date">
                            ...
                            <img src={post.User.image} className="image_banner" alt={post.User.firstName}/>
                        </div>
                    </div>
                    ...
                    <form id="app_modify_post" className="app_post app_modfiy_post">
                        ...
                        <button onClick={ e => { modifyPost(e, post.id) ; setVisible(!visible); setFocusPost(-1) }} className="btn btn_add_post">Modifier le post !</button>
                    </form>
                    }
                    <form onSubmit={e => addComment(e, post.id)} className="add_comment">
                        <div className="add_comment_form">
                            <label htmlFor="comment"></label>                          
                            <input className="input_form_comment" placeholder="Ajoutez un commentaire !" maxLength="250" type="text" id="comment" name="comment" value={comment.id} onChange={(e) => newComment(e.target.value) }/>                       
